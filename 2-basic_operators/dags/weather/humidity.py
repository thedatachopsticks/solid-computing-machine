...
from weather.urls import HUMIDITY_URL

class Humidity(WeatherBase):
    ...
    def store_data(self):
        ...
        entries = []
        fields = []
        with open("/opt/airflow/files/humidity.csv", "w", encoding="utf-8", newline="") as file:
