...
from weather.urls import WIND_DIRECTION_URL

class WindDirection(WeatherBase):
    ...
    def store_data(self):
        ...
        entries = []
        fields = []
        with open("/opt/airflow/files/windDirection.csv", "w", encoding="utf-8", newline="") as file:
